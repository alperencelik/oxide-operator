...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	...
	cp config/crd/bases/*.yaml charts/oxide-operator/crds/
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name oxide-operator-builder
	$(CONTAINER_TOOL) buildx use oxide-operator-builder
	...
	- $(CONTAINER_TOOL) buildx rm oxide-operator-builder
	rm Dockerfile.cross
